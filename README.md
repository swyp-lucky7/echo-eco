...
<br>
환경하면 사람들이 자기와 상관없다고 생각하는 사람들이 있고, 그런 사람들로 하여금 어떻게 환경에 대해 알릴까 고민하다가 앱테크 환경인식 프로젝트를 진행하게 되었습니다.<br>
<br>
...
# 우리팀의 강점
- 우리는 TDD 를 적용하여서 테스트 커버리지 80프로를 넘기고 있습니다.
  - 증명 사진 첨부 
- 코드 리뷰를 도입해 안티 패턴을 피하고, 좋은 코드를 적을 수 있도록 했습니다.
- 디스코드, 카카오톡을 통하여 빠른 소통하여 개발을 문제없이 진행했습니다.
...
특징은 하나의 EC2 서버를 사용하고 그안에 데이터베이스와 스프링 서버가 존재합니다. <br>
이미지 서버로 S3 를 이용하고 있고, 프런트팀과는 JWT 로 통신하고 있습니다.<br>

<br>
<br>

# ERD
URL: https://www.erdcloud.com/d/k2z8a7NSLZJ8pc9xi <br>
<사진 첨부 예정>
